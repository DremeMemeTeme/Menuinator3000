		...
		while (menuInput == 1) {
			...
			if (input == "3") {
				...
				if (currentDishes == 0) {
					...
					cout << "first element in order array : " << orderArray[0]->getName() << "\n";
					cout << "first element in dishSizes:  " << dishSizes[0] << "\n";
